...
famous_quote = "When you think you are done, you are only 40 percent done"
print (famous_quote)
...
bitcoin_rate ="8000"
print (bitcoin_rate)
todays_temperature = '70'
print (todays_temperature)
hawaii_population = '3,000,000'
...
market_update =" Today's bitcoin rate is "  + bitcoin_rate + " and the yen exchange rate is " +str(yen_rate)+"."
print(market_update)
...
fab_five = ['chocolate', 'fruit', 'ice cream', 'eggs', 'cucumbers']
print (fab_five)
...
plate_lunch =['sushi', 'steak', 'chicken katsu', 'garlic ahi', 'loco moco']
print (plate_lunch)
...
ice_cream = ['Rocky Road', 'Phish Food', 'Coffee Toffee']
print (ice_cream)
...
west_siiiiide =['Washington','Oregon']
print(west_siiiiide)
...
hamajang=['string', 'number', 'boolean', 'list', 'dictionary','tuple']
print (hamajang)
...
dynamic_duos =['left','right'] , ['coke','pepsi'] , ['carrots', 'peas']
print(dynamic_duos)
...
footwear = {'brand': 'Vivo Barefoot', 'url': 'https://www.vivobarefoot.com/us', 'gender': 'mens', 'type': 'alba canvas', 'price': 80, 'color': ['tan', 'black stripes', 'gum'], 'ordered': True}
print(footwear)
...
bank = {'name': 'First Hawaiian Bank', 'employees number': 2200, 'headquarters': 'Honolulu', 'Revenue': 700000000, 'nasdaq': 'FHB', 'products list': ['savings', 'loans', 'trust', 'wealth management'], 'executive': {'name': 'Robert Harrison','title': 'CEO', 'salary': 2000000}}
print(bank)
...
panda ={'name': 'Panda Express', 'restaurants': 2000, 'cuisine': 'gourmet chinese food', 'menu': ['orange chicken', 'walnut shrimp', 'sweet and sour pork'], 'highest revenue': 'ala moana food court'}
print(panda)
...
bucket_list={'travel': 'Canada', 'learn': 'coding', 'weight': 145, 'to-dos': 'finish homework', 'meet': 'elon musk' }
print(bucket_list)
